...
Shader "Lava"
{
	Properties
	{
		...
		[ASEBegin]_Brightness("Brightness", Float) = 0
		_LavaColor("Lava Color", Color) = (1,0,0,1)
		_NoiseScale("Noise Scale", Vector) = (5,5,0,0)
		_EmmisionMultiplier("Emmision Multiplier", Float) = 0
		_Speed("Speed", Float) = 0
		_Clamping("Clamping", Float) = 0.2
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 temp_output_47_0 = ( _FlowSpeed * _TimeParameters.x );
				float2 texCoord61 = IN.ase_texcoord7.xy * float2( 1,1 ) + ( temp_output_47_0 / float2( 4,4 ) );
				float mulTime12 = _TimeParameters.x * _Speed;
				float time32 = mulTime12;
				float voronoiSmooth0 = _Clamping;
				float2 texCoord26 = IN.ase_texcoord7.xy * _NoiseScale + temp_output_47_0;
				float2 coords32 = texCoord26 * 1.0;
				float2 id32 = 0;
				float2 uv32 = 0;
				float fade32 = 0.5;
				float voroi32 = 0;
				...
				voroi32 /= rest32;
				float4 temp_output_8_0 = ( _Brightness * tex2D( _MainTex, texCoord61 ) * ( _LavaColor * voroi32 ) );
				...
				float3 Emission = ( temp_output_8_0 * _EmmisionMultiplier ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_output_47_0 = ( _FlowSpeed * _TimeParameters.x );
				float2 texCoord61 = IN.ase_texcoord2.xy * float2( 1,1 ) + ( temp_output_47_0 / float2( 4,4 ) );
				float mulTime12 = _TimeParameters.x * _Speed;
				float time32 = mulTime12;
				float voronoiSmooth0 = _Clamping;
				float2 texCoord26 = IN.ase_texcoord2.xy * _NoiseScale + temp_output_47_0;
				float2 coords32 = texCoord26 * 1.0;
				float2 id32 = 0;
				float2 uv32 = 0;
				float fade32 = 0.5;
...
/*ASEBEGIN
Version=18701
255;127;1638;882;2050.364;450.9887;1.3;True;True
Node;AmplifyShaderEditor.SimpleTimeNode;45;-1665.315,-12.97628;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;46;-1682.315,-221.9762;Inherit;False;Property;_FlowSpeed;FlowSpeed;6;0;Create;True;0;0;False;0;False;1,1;0.2,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;47;-1474.515,-95.87625;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;42;-1413.807,358.0794;Inherit;False;Property;_Speed;Speed;4;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;29;-1455.24,178.58;Inherit;False;Property;_NoiseScale;Noise Scale;2;0;Create;True;0;0;False;0;False;5,5;4,4;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;26;-1195.238,84.07998;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleDivideOpNode;62;-1224.864,-151.9886;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT2;4,4;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-1086.206,484.1793;Inherit;False;Property;_Clamping;Clamping;5;0;Create;True;0;0;False;0;False;0.2;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;12;-1257.162,363.2193;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;10;-824.8321,-38.68809;Inherit;False;Property;_LavaColor;Lava Color;1;0;Create;True;0;0;False;0;False;1,0,0,1;1,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VoronoiNode;32;-904.9615,128.8193;Inherit;True;2;0;1;0;8;False;1;False;True;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;61;-1064.966,-248.1881;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-589.6849,43.50928;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;48;-649.7612,-256.3864;Inherit;True;Property;_MainTex;MainTex;7;0;Create;True;0;0;False;0;False;-1;None;0653990dfbe02174e98f60b50dbf84b2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;7;-323.6864,-330.5392;Inherit;False;Property;_Brightness;Brightness;0;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-154.1366,215.5153;Inherit;False;Property;_EmmisionMultiplier;Emmision Multiplier;3;0;Create;True;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-163.0305,-203.2782;Inherit;True;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;49;94.13892,-128.4864;Inherit;True;Property;_NormalMap;NormalMap;8;0;Create;True;0;0;False;0;False;-1;None;f05b911e0d876174bbe9f86e1acd5758;True;0;True;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;129.0898,198.3413;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=E96423017AD3021184F64A1CBCBCC4EBD47C6460